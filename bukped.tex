...
\newcommand{\myNameTwo}[1]{\def\@myNameTwo{#1}}
\newcommand{\myNIMTwo}[1]{\def\@myNIMTwo{#1}}
...
\myNIM{303012510004}
\myName{Ismi Nabilah}
\myNIMTwo{303012510005}
\myNameTwo{Nama Teman}
\myYear{2026}
