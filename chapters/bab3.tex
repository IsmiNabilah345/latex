...
\vspace{1cm}
\indent
Penelitian ini menggunakan metode Prototyping, yaitu pendekatan pengembangan sistem yang dilakukan secara iteratif melalui tahapan analisis kebutuhan, perancangan awal, pembangunan prototype, penyempurnaan sistem, hingga implementasi final. Metode ini dipilih karena kebutuhan sistem laundry belum sepenuhnya terdefinisi secara rinci pada tahap awal, sehingga diperlukan proses pengembangan yang fleksibel dan bertahap. Dengan adanya prototype, peneliti dapat menyusun gambaran awal sistem yang selanjutnya dapat disempurnakan agar sesuai dengan kebutuhan operasional dan kebiasaan kerja nyata di lingkungan laundry.


Objek penelitian dalam penelitian ini adalah sistem Point of Sales (POS) Laundry berbasis web yang dirancang untuk membantu proses pencatatan transaksi, pengelolaan data pelanggan, serta pembuatan laporan keuangan secara otomatis. Adapun subjek penelitian terdiri dari dua peran utama, yaitu pemilik usaha sebagai pengambil keputusan dan pengelola sistem, serta kasir yang bertugas menjalankan transaksi harian dan berinteraksi langsung dengan pelanggan.
    

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textwidth]{images/prototyping.jpeg}
        \caption{Prototyping}
